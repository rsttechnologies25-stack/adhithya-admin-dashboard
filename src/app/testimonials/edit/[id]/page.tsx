...
export default function EditTestimonialPage() {
    ...
    const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>) => {
        ...
        const val = type === 'checkbox' ? (e.target as HTMLInputElement).checked : (name === 'rating' ? parseInt(value) : value);
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px', maxWidth: '600px', margin: '0 auto' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                ...
                <h1 style={{ fontSize: '24px', fontWeight: 600, color: '#111827', margin: 0 }}>Edit Testimonial</h1>
            </div>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                            <input
                                ...
                                id="isActive"
                            />
                            <label htmlFor="isActive" style={labelStyle}>Active (Show on Home Page)</label>
                        </div>
                    </div>
                </div>
